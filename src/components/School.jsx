                    ...
                    <div className="mt-8 mb-8">
                        <div className="flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p className="text-center text-xl mt-4 mb-4 text-terracota">IUT de Chambéry</p>

                                <p className="text-2xl"><b className="text-5xl">Master ECNI</b> (Expert en création numérique interactive)</p>
                                <p className="text-center text-xl mt-4">- Spécialité développement web -</p>
                                <p className="text-center text-xl mt-4 text-terracota">Ecole by CCI x Gobelins Paris</p>

                            </div>
                        </div>
                        <p className="mt-16 text-center text-xl w-2/3 m-auto ">Grâce à ces formations, j’ai pu découvrir de nombreux domaines du multimédia comme l’audiovisuel, la communication, le graphisme et le développement web.
